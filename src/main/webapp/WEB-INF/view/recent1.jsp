			...
			<div id="fh5co-blog-section" class="fh5co-section-gray">
				<div class="container">
					<div class="row">
						...
						<ul>
							<li
								style="margin-left: 20%; margin-top: 5%; font-size: 20px; list-style: none;"><a
								href="/toliuyan" name="update">去留言</a></li>
						</ul>
					</div>
				</div>
				<div class="container">
						...
						<c:forEach var="e" items="${list}">
							<div class="col-lg-4 col-md-4 col-sm-6">
								<div class="fh5co-blog animate-box">
									<div class="blog-text">
										<div class="prod-title">
											<span class="by">by <c:out value="${e.username }"></c:out></span>
