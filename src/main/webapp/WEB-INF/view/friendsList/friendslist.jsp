	...
	<div class="container">
		...
		<div id="main" style="width: 70%;">
			...
			<div id="right" style="display:inline-block;height: 700px;border: 2px;border-style: solid;width: 70%;float: left;">
				...
				<form action="/allow1">
					<p style="margin-left:10%;font-size:18px;"> 好友1:${sessionScope.f1 }<a href="/photoForOther?otherUsername=${sessionScope.f1 }">ta的照片墙</a>&nbsp<a href="">ta的留言板</a></p>
				</form>
				<form action="/allow1">
					<p style="margin-left:10%;font-size:18px;"> 好友2:${sessionScope.f2 }<a href="/photoForOther?otherUsername=${sessionScope.f2 }">ta的照片墙</a>&nbsp<a href="">ta的留言板</a></p>
				</form>
				<form action="/allow1">
					<p style="margin-left:10%;font-size:18px;"> 好友3:${sessionScope.f3 }<a href="/photoForOther?otherUsername=${sessionScope.f3 }">ta的照片墙</a>&nbsp<a href="">ta的留言板</a></p>
				</form>
							<form action="/allow1">
					<p style="margin-left:10%;font-size:18px;"> 好友4:${sessionScope.f4 }<a href="/photoForOther?otherUsername=${sessionScope.f4 }">ta的照片墙</a>&nbsp<a href="">ta的留言板</a></p>
				</form>
				<form action="/allow1">
					<p style="margin-left:10%;font-size:18px;"> 好友5:${sessionScope.f5 }<a href="/photoForOther?otherUsername=${sessionScope.f5 }">ta的照片墙</a>&nbsp<a href="">ta的留言板</a></p>
				</form>
