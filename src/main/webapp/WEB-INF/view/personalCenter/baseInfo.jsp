			...
			<div >
				...
				<div >
					...
					<ul  style="list-style:none;font-size: 16px;color: #848484;font-family: "Open Sans", Arial, sans-serif;" >
						...
						<li style="margin-left:10%;margin-top:5%;font-size:18px;">新密码:<input type="password" style="width:30%" class="form-control" name="password" value="${sessionScope.accountInfo.getPassword() }"></li>
